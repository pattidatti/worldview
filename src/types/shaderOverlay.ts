export type ShaderOverlayMode = 'none' | 'nightvision' | 'crt' | 'thermal' | 'anime' | 'terminator';
...
export const SHADER_OVERLAY_MODES: { id: ShaderOverlayMode; label: string; icon: string; description: string }[] = [
    ...
    { id: 'terminator',  label: 'Dag/natt',   icon: '🌗', description: 'Bykjerner + atmosfæregløde ved terminatoren' },
];
